...
def pad_corpus(french, english):
	...
	for line in english:
		...
		padded_ENGLISH = [START_TOKEN] + padded_ENGLISH + [STOP_TOKEN] + [PAD_TOKEN] #+ [PAD_TOKEN] * (ENGLISH_WINDOW_SIZE - len(padded_ENGLISH)-1)
...
def get_data(data_file):
	...
	english2 = english1[round(len(english1) * 0.95) : ]
	english1 = english1[0 : round(len(english1) * 0.95)]
	french2 = french1[round(len(french1) * 0.95) : ]
	french1 = french1[0 : round(len(french1) * 0.95)]
